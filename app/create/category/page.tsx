            ...
            <main className={'w-9/12 h-auto mb-28'}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={'w-full flex justify-between'}>
                        <div className={'w-2/5'}>
                            <h2 className={'text-lg mb-2'}>Nazwa kategorii</h2>
                            <p className={'text-zinc-500 font-light text-sm'}>Nazwa kategorii, która ma ułatwić segregowanie przedmiotów w szafie</p>
                        </div>
                    ...
                    <div className={'w-full flex justify-between'}>
                        <div className={'w-2/5'}>
                            <h2 className={'text-lg mb-2'}>Kolor kategorii</h2>
                            <p className={'text-zinc-500 font-light text-sm'}>Ustaw kolor, który ułatwi wizualne rozpoznanie szuflad w kategorii</p>
                        </div>
                        <div className={'w-1/3 text-xs text-red-600'}>
                            <div className={'flex flex-col'}>
                    ...
                    <div className={'w-full flex justify-between'}>
                        <div className={'w-2/5'}>
                            <h2 className={'text-lg mb-2'}>Opis kategorii</h2>
                            <p className={'text-zinc-500 font-light text-sm'}>Opis kategorii, ważna informacja dla obsługującego szafy</p>
                        </div>
                        <div className={'w-1/3 text-xs text-red-600'}>
                            <div className={'flex flex-col'}>
                                <textarea
